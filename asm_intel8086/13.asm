;Desigur am putea spune dintr-o privire ca numarul de elemente impare este 4 dar aceasta valoare am obtinut-o noi nu calculatorul :)
...
;va trebui sa tinem minte numarul de numere impare. Pentru asta vom folosi bx
mov bx, 0; initial am gasit 0 numere impare
...
urmatorulElement:
	...
	div bx
	;acum ca am terminat cu bx pot sa pun in el din nou numarul de elemente impare gasite
	mov bx, cx; bx=cx
	
	;daca dx(restul) este 1 atunci numarul este impar, daca dx este diferit de 1 (adica 0) atunci numarul este par
	cmp dx, 0; seteaza ZF=0 daca dx=0 si seteaza ZF=1 daca dx e diferit de 0
	jz ePar;daca ZF=0 atunci sari mai jos la eticheta "ePar"
	;daca a ajuns aici inseamna ca ZF nu e 0 deci dx nu e 0 deci dx e 1 deci numarul este impar
	add bx, 1; bx = bx+1 pentru ca am mai gasit un numar impar
	ePar:
